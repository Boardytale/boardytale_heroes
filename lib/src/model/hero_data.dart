...
class HeroData {
  ...
  int get _sumPhysical=>_strength+_agility+_intelligence+floatAgility+floatIntelligence+floatStrength;
  int get _sumMystical=>_energy+_darkness+_precision+floatDarkness+floatEnergy+floatPrecision;
